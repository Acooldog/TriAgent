...
import type { ProviderRuntimeDescriptor, ProviderRuntimeExit, ProviderRuntimeInstance } from "../../application/provider/protocols/providerRuntimeProtocol";
import { PrivateProviderRuntimeGateway, type PrivateProviderRuntimeBackend } from "../../infrastructure/providers/gateways/privateProviderRuntimeGateway";
