...
import type { StructuredContextCompressor, CompressionOptions } from "../application/settings/contextCompression";
...
import type { SessionPersistenceService, SessionTaskState } from "../application/agent/sessionPersistence";
