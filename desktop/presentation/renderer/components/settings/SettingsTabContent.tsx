...
export function SettingsTabContent({
  ...
  const { settingsTab, networkEnabled, toggleNetwork, mode, selectMode, modelConfig, autoCompression, setAutoCompression, compressionThreshold, setCompressionThreshold, navigateTo, workspaceRoot, showToast } = state;
