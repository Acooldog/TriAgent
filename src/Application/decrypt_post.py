...
from src.Application.decrypt_cover import (
...
from src.Infrastructure.transcoder import (
    normalize_target_format, probe_media_summary, summary_to_log, transcode_file,
)
...
def _resolve_publish_target(
    *, base_name: str, input_path: pathlib.Path, extension: str,
    ...
    manifest_repo: OutputManifestRepository, config: BatchRunConfig,
