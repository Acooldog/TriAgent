...
so that this module stays focused on orchestration: build jobs from rules and
input paths, and run them in parallel via ThreadPoolExecutor.
"""
...
from src.Application.transcode_models import (
    ALL_SOURCE_FORMAT,
...
# Re-export the constants and normalize fns from transcode_models.
from src.Application.transcode_models import (  # noqa: E402,F401
    TRANSCODE_SOURCE_FORMATS,
    TRANSCODE_TARGET_FORMATS,
    TRANSCODE_SAMPLE_RATE_OPTIONS,
    TRANSCODE_BITRATE_OPTIONS,
