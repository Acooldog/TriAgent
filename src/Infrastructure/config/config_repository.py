...
Project metadata constants (CONFIG_NAMESPACE, PROJECT_NAME_EN, ...) now live
in ``src.Domain.constants`` (the hexagonal inner layer). This module re-exports
...
from src.Infrastructure.config.config_paths import (
...
from src.Infrastructure.adapters.runtime.runtime_paths import RuntimePaths, appdata_path
from src.Infrastructure.adapters.media.transcode.transcoder import SUPPORTED_TARGET_FORMATS, normalize_target_format
