...
from src.Infrastructure.adapters.media.cover.cover_art_search import (
    COVER_URL_TEMPLATE,
    search_cover_online,
    download_cover_image,
    _cache_key,
)
from src.Infrastructure.adapters.media.cover.cover_embedder import (
    AlbumMetadataResult,
    CoverArtResult,
...
# Implements: src.Domain.ports.CoverArtPort
