...
from src.Infrastructure.adapters.runtime.process_utils import find_process_by_name, find_process_by_substring
...
class QQPlatformAdapter:
    ...
    def _ensure_variant_adapter(self) -> QQVariantAdapterService:
        if self._variant_adapter is None:
            from src.Infrastructure.adapters.platforms.qq.decrypt.variant_adapter import QQVariantAdapterService
