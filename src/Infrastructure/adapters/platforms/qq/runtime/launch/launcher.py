...
from src.Infrastructure.adapters.runtime.process_utils import find_process_by_name
...
def is_qqmusic_running() -> bool:
    ...
    if info is not None:
        return True
    # 有些版本进程名小写或带后缀
    from src.Infrastructure.adapters.runtime.process_utils import find_process_by_substring
