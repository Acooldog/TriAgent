...
import frida
from src.Infrastructure.adapters.platforms.qq.decrypt.scripts import build_active_script, build_redirect_script
from src.Infrastructure.adapters.platforms.qq.decrypt.internal_direct_helpers import (
    ACTIVE_ARG0_HEX,
    ACTIVE_ARG1_HEX,
    CACHE_DIR,
    PICTURE_DIR,
